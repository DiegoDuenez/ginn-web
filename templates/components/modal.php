<div class="modal">
  ...
  <button class="modal__button" id="modalButtonCerrar">
  ...
  <div class="modal__col ">
    ...
    <div class="modal__container modal__container--p-0">
      ...
      <div class="modal__row modal__row--reverse">
        ...
        <div class="modal__image">
          <img src="resources/img/edge.png" alt="Leed">
        </div>
      ...
      <div class="modal__row">
        ...
        <div class="modal__content">
          Tener la certificación AAA significa que nuestras empresas han sido revisadas por las autoridades 
          mexicanas como entidades sujetas a impuestos que están al día en sus declaraciones y pagos, que tienen un historial
