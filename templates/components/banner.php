<div class="banner">
    ...
    <div class="container-glider">
        ...
        <div class="glider">
            <div class="card">
                <img src="resources/img/banner1.png" alt="GINN" loading="lazy">
            </div>
            <div class="card">
                <img src="resources/img/banner2.png" alt="GINN" loading="lazy">
            </div>
            <div class="card">
                <img src="resources/img/banner3.png" alt="GINN" loading="lazy">
            </div>
        </div>
    ...
    <div class="banner__mask animate__animated animate__fadeInLeft">
        <h1 class="banner__title animate__animated animate__zoomIn animate__delay-1s">DESARROLLOS CON PROPÓSITO</h1>
